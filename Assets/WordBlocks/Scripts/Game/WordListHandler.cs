...
namespace BBG.WordBlocks
{
	public class WordListHandler : UIMonoBehaviour
	{
		...
		//new added
        [Tooltip("The vertical space at the bottom of the grid where words cannot be placed.")]
        [SerializeField] private float bottomAreaHeight = 100f; // Adjust this value as needed
