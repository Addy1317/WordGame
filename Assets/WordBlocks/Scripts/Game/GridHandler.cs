...
namespace BBG.WordBlocks
{
    public class GridHandler : UIMonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        private void SetupGrid()
        {
            ...
            for (int row = 0; row < boardData.rows; row++)
            {
                ...
                for (int col = 0; col < boardData.cols; col++)
                {
                    ...
                    // Debug.Log("gridCell: " + gridCell.letter + " Cell " + (boardData.board[row][col]));
        ...
        {
            Debug.Log("GetGridCellPositions");
        ...
        {
            Debug.Log("GetGridCellsAtPositions");
        ...
        {
            Debug.Log("Shifts the tiles so there are no blanks between first and last non blank cell");
